 ...
 * @throws Exception 
  ...
  public void Init() throws Exception
  {
    ...
    if (!m_bRun)
    {
      ar = new AudioRecord(1, 5000, channelConfiguration, audioEncoding, AudioRecord.getMinBufferSize(20000, channelConfiguration, audioEncoding));
      if (ar.getState() != 1)
      return;
    ...
    while (true)
    {
      buffersizebytes = AudioRecord.getMinBufferSize(10000, channelConfiguration, audioEncoding);
